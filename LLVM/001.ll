...
@a = global i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), align 8
@b = global i32 0, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"bye\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_001.cpp, i8* null }]
